...
<form id="login" method="post" action="../j_spring_security_check"> 
	  ...
	  <img src="${pageContext.request.contextPath}/mobile/findImageByUsername?username=${username}"/>
	  Change Profile Pic.
	  <br/>
    ...
    <div>
    	...
    	<input type="text" name="j_username" id="login_username" class="field required" title="Please provide your username" />
    </div>			

    <div>
    	<label for="login_password">Password</label>
    	<input type="password" name="j_password" id="login_password" class="field required" title="Password is required" />
    </div>			
    ...
    <div class="submit">
        ...
        <label>
           ...
           <a href="${pageContext.request.contextPath}/mobile/userProfile"><img src="${pageContext.request.contextPath}/img/new.gif" style="margin-top: 10px"/><img src="${pageContext.request.contextPath}/img/profile.png" style="margin-top: 10px"/></a>  
                      <a href="${pageContext.request.contextPath}/mobile/profiles"><img src="${pageContext.request.contextPath}/img/new.gif" style="margin-top: 10px"/><img src="${pageContext.request.contextPath}/img/profile.png" style="margin-top: 10px"/></a>
