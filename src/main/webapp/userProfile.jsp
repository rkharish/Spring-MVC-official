...
<sp:form id="login" method="post" action="mobile/userProfile" commandName="profileCommand" enctype="multipart/form-data"> 
	  <img src="img/pic2.jpg"/> User Profile Page
	  <br/>
    ...
    <div>
    	...
    	<input type="text" name="username" id="username" class="field required" title="Please provide your Name" />
    </div>			
    
    
    
    <div>
    	<label for="login_username">Title:*</label> 
    	<input type="text" name="title" id="title" class="field required" title="Please provide your title" />
    </div>			
    	
    	
    	   
    <div>
    	<label for="login_username">Company Name:*</label> 
    	<input type="text" name="companyName" id="title" class="field required" title="Please provide your Company Name" />
    </div>
    
        	   
    <div>
    	<label for="login_username">City:*</label> 
    	<input type="text" name="city" id="city" class="field required" title="Please provide your City Name" />
    </div>
    ...
    <div>
    	<label for="login_username">Profile Pic</label> 
    	<input type="file" name="photo" id="photo" class="field required"/>
    </div>
